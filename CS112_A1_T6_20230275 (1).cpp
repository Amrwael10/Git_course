// File: connect 4
// program: A board of 7 columns and 6 rows and two players play x or o till one of them connect 4 symbols horizontally , vertically or diagonally and he wins.
// Author: Amr Wael Mousa Abd El Fatah 
// version: 4.0
// Date: 3/3/2024
#include <iostream>
using namespace std;
